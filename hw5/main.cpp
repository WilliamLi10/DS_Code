...
// ===================================================================
//test to test erasing an entire list and repeated pushbacks for large inputs
void Test1()
{
 UnrolledLL<int> a;
 std::list<int> b;
...
//test to make sure copy constructor and assignment operator work 
void Test2()
{
  UnrolledLL<char> a;
  for(int i = 0; i != 20; ++i)
...
//more tests for insert copy constructor, and insert
void Test3()
{
  UnrolledLL<int> a;
