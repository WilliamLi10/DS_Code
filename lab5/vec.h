...
{
  std::cout << "Printing Vec Contents:" << std::endl;
  std::cout << "Number of elements: " << m_size << std::endl;
  std::cout << "Space allocated: " << m_alloc << std::endl;
...
//ALLEN CODE GOES HERE
template <class T> typename Vec<T>::iterator Vec<T>::insert(iterator p, const T& t) {

  // GET RID OF NULL RETURN STATEMENT AND IMPLEMENT CODE HERE
  return NULL;
}

template <class T> typename Vec<T>::iterator Vec<T>::find(const T& t) { 
  // GET RID OF NULL RETURN STATEMENT AND IMPLEMENT CODE HERE
  return NULL;
}
